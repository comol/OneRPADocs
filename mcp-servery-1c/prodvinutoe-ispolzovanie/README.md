...
docker run -d -p 8011:8011 --name 1c_forms_mcp -e LICENSE_KEY=$LICENSE_KEY comol/1c_forms:latest
```

### Остановка всех серверов

```powershell
docker stop 1c_help_mcp 1c_syntaxcheck_mcp 1c_forms_mcp mcp_ssl_server template_search_mcp
```
