...
Ниже приведён готовый PowerShell-скрипт для Windows. Сами MCP-серверы также запускаются на Linux и macOS; для Bash замените пути хоста и переносы строк PowerShell на синтаксис вашей оболочки.
