...
2. **Индексация данных** (от минут до часов)
   * Зависит от объёма данных
   * CPU модели работают медленнее GPU
...
| Аспект              | CPU (e5-base)      | GPU (Qwen-4B)     |
| ------------------- | ------------------ | ----------------- |
| Качество поиска     | Хорошее            | Отличное          |
| Скорость индексации | 10-30 мин/1000 док | 1-3 мин/1000 док  |
...
3. Попробуйте через VPN (если заблокирован)
