...
Срок первичной индексации CodeMetadataSearch оценивайте по [замеру на своём корпусе](../servery/code-metadata-search/vremya-indeksacii.md), а не по неподтверждённой норме «часов на 1000 документов».

| Аспект              | CPU (e5-base)        | GPU (Qwen-4B через LM Studio) |
| ------------------- | -------------------- | ----------------------------- |
| Качество поиска     | Хорошее              | Отличное                      |
| Скорость индексации | Зависит от корпуса и CPU | Зависит от корпуса, GPU и модели |
