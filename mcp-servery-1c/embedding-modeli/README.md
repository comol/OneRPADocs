...
{% hint style="warning" %}
При смене embedding модели весь индекс пересоздаётся. Это может занять несколько часов для больших конфигураций.
{% endhint %}
...
- [LM Studio (рекомендуется)](lm-studio.md) — настройка LM Studio с Qwen
- [CPU режим](cpu-modeli.md) — работа без GPU
- [Ollama](ollama.md) — альтернатива LM Studio
