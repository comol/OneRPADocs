...
{% hint style="warning" %}
Индексация — ресурсоёмкий процесс. Планируйте первый запуск заранее: одна ночь не гарантирует завершения большой конфигурации. Для CodeMetadataSearch см. [подтверждённый пример и методику оценки](../servery/code-metadata-search/vremya-indeksacii.md); таблица ниже не задаёт норматив для УТ/ERP.
{% endhint %}
...
| CodeMetadataSearchServer | Замер на своём корпусе | Замер на своём корпусе |
