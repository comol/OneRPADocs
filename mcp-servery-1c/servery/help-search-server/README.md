...
| Инструмент | Описание |
|------------|----------|
| `docsearch` | Поиск по справке платформы 1С (методы, свойства, события, синтаксис) |

### docsearch

Поиск по документации синтаксиса 1С. Комбинирует векторный (семантический) и полнотекстовый поиск. Если известно имя метода или функции — указывайте только имя. Если имя неизвестно — опишите нужную функциональность.

| Параметр | Тип | Описание |
|----------|-----|----------|
| `query` | string | Имя метода, свойства или описание нужной функциональности (на русском языке) |
