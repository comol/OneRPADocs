...
Поиск объектов метаданных, реквизитов и типов в конфигурации 1С. Для поиска по имени используйте формат вида `Справочники.ИмяСправочника.Реквизиты`. Для поиска по описанию — текст на русском языке.

| Параметр | Тип | По умолчанию | Описание |
|----------|-----|--------------|----------|
| `query` | string | — | Имя или описание объекта метаданных |
| `limit` | int | 20 | Количество результатов. Увеличьте для объектов с большим числом реквизитов, уменьшите для экономии контекста |
