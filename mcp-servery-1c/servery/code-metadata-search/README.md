...
| Инструмент | Описание |
|------------|----------|
| `search_metadata` | Поиск объектов конфигурации по имени или описанию |
| `search_attributes` | Поиск реквизитов по имени |
| `search_code` | Поиск по тексту кода модулей |
| `get_object_info` | Подробная информация об объекте метаданных |
| `search_config_help` | Поиск по справке конфигурации |
