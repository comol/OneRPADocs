...
Плагины этим сервером не поддерживаются: настройка ведётся составом индексируемых данных и параметрами поиска. См. [Серверы без плагинов](../../sistema-pluginov/dorabotka-bez-pluginov.md).
