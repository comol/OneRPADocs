...
{% hint style="warning" %}
Преобразование ссылок из `response_markdown` относится к текущему beta-кандидату исходников. В stable и ранее опубликованных beta-образах поиск может возвращать записи только из `response_details`; если этот список пуст, ссылки из результата инструмента там ещё не превращаются в `id`.
{% endhint %}
