...
|--------|---------------|-------------------|
| Провайдер | 1С:Напарник (code.1c.ai) | BSL Language Server |
| Синтаксис | ✅ | ✅ |
| Логика и производительность | ✅ | ❌ |
| Стиль и стандарты ИТС | ✅ | Частично |
| Переписывание кода | ✅ | ❌ |
...
{% hint style="info" %}
Серверы не конфликтуют — можно использовать оба одновременно. SyntaxCheckServer для быстрой офлайн-проверки синтаксиса, 1CCodeChecker для глубокого анализа и работы с документацией.
{% endhint %}
