...
| [FormsServer](servery/forms-server/) | 8011 | Схемы для генерации форм | Нет |
...
2. **FormsServer** — контекст для генерации форм
3. **SSLSearchServer** — если используете БСП
...
|---------|-------------------|
| **LM Studio + Qwen** | Есть GPU NVIDIA — лучшее качество |
| **CPU режим** | Нет GPU — работает везде |
...
- [Embedding модели](embedding-modeli/) — LM Studio, CPU, Ollama
